import { IPositionStats, IScrollerDistance, IScrollState } from './models';
...
export function isTriggeredScroll(totalToScroll: number, scrollState: IScrollState, isScrollingDown: boolean) {
