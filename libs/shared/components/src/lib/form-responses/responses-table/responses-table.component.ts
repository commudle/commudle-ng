...
import { IDataForm, IQuestion } from '@commudle/shared-models';
import { debounceTime, switchMap } from 'rxjs/operators';
import { SDataFormEntityResponseGroupsService } from '../../services/s-data-form-entity-response-groups.service';

@Component({
  selector: 'commudle-responses-table',
