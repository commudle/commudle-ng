...
@Component({
  selector: 'app-speaker-resource-discussion-message',
  templateUrl: './speaker-resource-discussion-message.component.html',
  styleUrls: ['./speaker-resource-discussion-message.component.scss']
})
export class SpeakerResourceDiscussionMessageComponent implements OnInit {
