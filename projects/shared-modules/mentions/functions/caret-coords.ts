...
export function getCaretCoordinates(element, position, options) {
  ...
  // The mirror div will replicate the text area's style
  ...
  if (isFirefox) {
    // Firefox lies about the overflow property for text areas: https://bugzilla.mozilla.org/show_bug.cgi?id=984275
  ...
  // text area's content into the <span> created at the caret position.
