...
import { getCaretCoordinates } from 'projects/shared-modules/mentions/functions/caret-coords';
import { getContentEditableCaretCoords, isInputOrTextAreaElement } from 'projects/shared-modules/mentions/functions/mentions-utils';
...
export class MentionsListComponent implements AfterContentChecked {
  ...
  private static getBlockCursorDimensions(nativeParentElement: HTMLInputElement) {
  ...
  position(nativeParentElement: HTMLInputElement, iframe: HTMLIFrameElement = null) {
    if (isInputOrTextAreaElement(nativeParentElement)) {
      ...
      this.offset = MentionsListComponent.getBlockCursorDimensions(nativeParentElement).height;
    } else if (iframe) {
