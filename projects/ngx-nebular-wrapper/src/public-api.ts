...
// export * from './lib/ngx-nebular-wrapper.module';
// export {
//   NbCardComponent,
...
export * from '@nebular/eva-icons/eva-icons.module';

export * from '@nebular/theme/theme.options';
...
export * from '@nebular/theme/components/card/card.module';
export * from '@nebular/theme/components/card/card.component';
export * from '@nebular/theme/components/card/flip-card/flip-card.component';
export * from '@nebular/theme/components/card/reveal-card/reveal-card.component';
export * from '@nebular/theme/components/card/shared/shared.component';
