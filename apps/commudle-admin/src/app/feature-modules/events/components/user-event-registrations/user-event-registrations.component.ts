...
import { EemailTypes, EUserRoles, ICommunity, IEvent, IRegistrationStatus } from '@commudle/shared-models';
import { AppUsersService, LibToastLogService } from '@commudle/shared-services';
...
@Component({
  selector: 'commudle-user-event-registrations',
