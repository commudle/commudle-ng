...
import { IEventLocation, EEventType } from '@commudle/shared-models';
...
import { EEmbeddedVideoStreamSources } from '@commudle/shared-models';
import { DomSanitizer } from '@angular/platform-browser';
import { ICommunity } from '@commudle/shared-models';


@Component({
  selector: 'commudle-event-locations',
