...
import { EUserRoles, EUserRolesUserStatus, ICurrentUser, IUserRolesUser } from '@commudle/shared-models';
import { LibAuthwatchService, UserChatsService } from '@commudle/shared-services';
import { NB_WINDOW, NbMenuService, NbWindowService } from '@nebular/theme';
import { filter, map } from 'rxjs/operators';

@Component({
  selector: 'commudle-member',
