  ...
  theme: {
    extend: {
      colors: {
        ...
        'Auro-Metal-Saurus': 'var(--color-auro-metal-saurus)',
        'Dark-Jungle-Green': 'var(--color-dark-jungle-green)',
        //Checked till above

        'Light-Silver': 'var(--color-light-silver)',
        'Bright-Gray-Light': 'var(--color-bright-gray-light)',
        'Crayola-Green': 'var(--color-crayola-green)',
        'Vampire-Black': 'var(--color-vampire-black)',
        'Anti-Flash-White': 'var(--color-anti-flash-white)',
        'Yankees-Blue': 'var(--color-yankees-blue)',
        'Alice-Blue': 'var(--color-alice-blue)',
        'New-Car': 'var(--color-new-car)',

        'Bright-Gray': '#E4E9F2',

        'Chrome-Yellow': 'var(--color-chrome-yellow)',
        'Infra-Red': 'var(--color-infra-red)',
        Quartz: 'var(--color-quartz)',
        'Chocolate-Traditional': 'var(--color-chocolate-traditional)',
        ...
        'Catalina-Blue': 'var(--color-catalina-blue)',
